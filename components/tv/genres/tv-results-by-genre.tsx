...
interface TVResultsByGenreProps {
...
export default function TVResultsByGenre({
  tvResponse,
  config,
  currentPage,
  genreId,
}: TVResultsByGenreProps) {
    ...
    <section id="searchResults">
      <div className="container mx-auto px-4 sm:px-0 py-4">
        ...
        <div className="w-full py-4 flex justify-center">
          <Pagination currentPage={currentPage} tv={tvResponse} genreId={genreId} />
        </div>
      </div>
    </section>
  );
