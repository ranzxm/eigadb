...
interface NowPlayingResultsProps {
...
export default function NowPlayingResults({
  moviesResponse,
  config,
  currentPage,
  slug,
}: NowPlayingResultsProps) {
    ...
    <section id="searchResults">
      <div className="container mx-auto px-4 sm:px-0 py-4">
        ...
        <div className="w-full py-4 flex justify-center">
          <Pagination currentPage={currentPage} movies={moviesResponse} slug={slug} />
        </div>
      </div>
    </section>
  );
